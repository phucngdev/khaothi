...
import type { UpsertExamResultAdminDto } from '../requests/models/UpsertExamResultAdminDto';
...
export type ExamResultServiceExamResultControllerUpsertExamResultMutationResult =
  Awaited<
    ReturnType<typeof ExamResultService.examResultControllerUpsertExamResult>
  >;

/**
 * Upsert exam result for student by admin
 */
export const useExamResultServiceExamResultControllerUpsertExamResult = <
  TData = ExamResultServiceExamResultControllerUpsertExamResultMutationResult,
  TError = unknown,
  TContext = unknown,
>(
  options?: Omit<
  ...
  >({
    mutationFn: ({ requestBody }) =>
      ExamResultService.examResultControllerUpsertExamResult(
        requestBody,
      ) as unknown as Promise<TData>,
    ...options,
  });
...
>(
  ...
  useQuery<TData, TError>({
    ...
    queryKey: [
      ...
      ...(queryKey ?? [{ categoryId, limit, offset, order }]),
    ],
    ...options,
  });
